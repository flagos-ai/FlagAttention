...
def forward(q, k, v, q_scale, k_scale, tensor_layout="HND", attn_mask=None,
    ...
    if maxnreg is not None:
        ...
        # Triton-Ascend rejects maxnreg as a launch option. Keep the public
        # compatibility argument and validate it, but let the backend choose.
    ...
    _attn_fwd[grid](
        ...
        Q_SCALE_BLOCK=q_scale_block, K_SCALE_BLOCK=k_scale_block,
        **launch_options)
